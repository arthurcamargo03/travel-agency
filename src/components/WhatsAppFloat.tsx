...
export default function WhatsAppFloat() {
  return (
    ...
    >
      {/* Label — aparece ao hover no desktop */}
      <span className="hidden sm:block max-w-0 overflow-hidden group-hover:max-w-xs transition-all duration-300 whitespace-nowrap pl-0 group-hover:pl-4 font-semibold text-sm">
        Falar no WhatsApp
      </span>
